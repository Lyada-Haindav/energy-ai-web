  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#f4efe4] text-[#10261b]">
      ...
      <section className="relative mx-auto flex min-h-screen w-full max-w-[1380px] flex-col px-4 pb-10 pt-6 lg:px-6">
        ...
        <div className="grid flex-1 items-center gap-10 py-10 lg:grid-cols-[minmax(0,1.02fr)_540px] lg:py-14">
          ...
          <div className="relative min-h-[520px]">
            <div className="absolute inset-0 rounded-[44px] bg-[linear-gradient(155deg,rgba(16,38,27,0.94)_0%,rgba(34,118,82,0.88)_44%,rgba(255,145,98,0.82)_100%)] shadow-[0_50px_120px_-60px_rgba(16,38,27,0.85)]" />
            <div className="absolute inset-4 rounded-[36px] border border-white/16 bg-[linear-gradient(180deg,rgba(255,255,255,0.16)_0%,rgba(255,255,255,0.06)_100%)]" />

            <div className="absolute left-6 top-6 rounded-full border border-white/20 bg-white/12 px-4 py-2 text-sm font-semibold uppercase tracking-[0.22em] text-white/70">
              Energy routing
            </div>

            <div className="absolute left-1/2 top-1/2 w-[88%] max-w-[440px] -translate-x-1/2 -translate-y-1/2 rounded-[34px] border border-white/20 bg-[#fffdf7]/90 p-5 shadow-[0_35px_90px_-55px_rgba(16,38,27,0.8)]">
              <p className="text-xs uppercase tracking-[0.22em] text-[#6d826f]">Model preview</p>
              <h2 className="mt-2 font-display text-3xl font-bold tracking-[-0.04em] text-[#10261b]">Choose speed. Keep depth.</h2>
