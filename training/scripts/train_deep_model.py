...
def load_system_prompt():
  prompt_path = Path(__file__).resolve().parent.parent / "prompts" / "deep_system.txt"
...
def main():
  parser = argparse.ArgumentParser(description="Train deep analysis model with LoRA SFT.")
